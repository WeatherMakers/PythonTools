...
set "output_dir=!folder_name!ASTC4x4E"
...
for %%f in (*.png) do (
    set "filename=%%~nf"
    echo Processing: %%f
toktx --encode astc --astc_blk_d 4x4 --astc_mode ldr --astc_quality exhaustive --t2 --assign_oetf linear "!output_dir!\!filename!.ktx2" "%%f"
